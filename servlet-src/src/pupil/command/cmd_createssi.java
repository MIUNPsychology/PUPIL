...
public class cmd_createssi extends Command
{
  private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(cmd_createssi.class);

  public cmd_createssi(DBManager dbm, StaticInfoBlob info)
  {
    super(dbm,info);
  }
