...
public class cmd_addcategory extends Command
{
  private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(cmd_addcategory.class);

  public cmd_addcategory(DBManager dbm, StaticInfoBlob info)
  {
    super(dbm,info);
  }
  ...
  {
    log.trace("Enter cmd_addcategory()");
    ...
    try
    {
      ps = db.getPreparedStatement("INSERT INTO category(name,project_id) VALUES(?,?)");
      ps.setString(1,name);
    ...
    log.trace("Leave cmd_addcategory()");
