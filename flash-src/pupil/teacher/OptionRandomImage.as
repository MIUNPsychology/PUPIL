package pupil.teacher
{
  ...
  public class OptionRandomImage
  {
    ...
    public function OptionRandomImage(myscreen:SFScreen, parentwin:ProjectDetails, pattern:String, projname:String)
    {
      screen = myscreen;
      myparent = parentwin;
...
//      SFScreen.addDebug("optclick()");
    ...
    private function onCreateClick(e:MouseEvent):void
    {
      ...
      var xml:String = "<command><function>createsori</function>";
