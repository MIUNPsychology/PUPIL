package pupil.teacher
{
  ...
  public class SelectStaticImage
  {
    ...
    public function SelectStaticImage(myscreen:SFScreen, parentwin:ProjectDetails, pattern:String, projname:String)
    {
      screen = myscreen;
      myparent = parentwin;
      ...
      frmMain = new SFFrame(screen,170,70,695,465,"Select Static Image");
    ...
    private function onCreateClick(e:MouseEvent):void
    {
      ...
      var xml:String = "<command><function>createssi</function>";
